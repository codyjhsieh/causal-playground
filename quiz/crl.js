export const questions = [
  ...
  {
    q: "The true latent signals in the module are z-scored PKA and P38 protein measurements from Sachs et al. (Science 2005), which have an empirical correlation of approximately 0.12. After mixing with A(θ) and then recovering with B = A⁻¹ using both interventions, what should the recovered ẑ₁ and ẑ₂ look like relative to the original PKA and P38 clouds?",
    choices: [
